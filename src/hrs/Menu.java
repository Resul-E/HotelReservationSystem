...
public class Menu {
	...
	private ArrayList<Calculable> expenseLs;
	private ArrayList<Services> incomeLs; 
	
	public Menu() {
		
		gui = new SystemGUI(this);
		
		expenseLs = new ArrayList<Calculable>();
		incomeLs = new ArrayList<Services>();
	...
	public ArrayList<Calculable> getExpenseLs() {
		return expenseLs;
	}

	public void setExpenseLs(ArrayList<Calculable> expenseLs) {
		this.expenseLs = expenseLs;
	}

	public ArrayList<Services> getIncomeLs() {
		return incomeLs;
	}

	public void setIncomeLs(ArrayList<Services> incomeLs) {
		this.incomeLs = incomeLs;
	}
